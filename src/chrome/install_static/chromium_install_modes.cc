// Copyright 2016 The Ninarium Authors
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.

// Brand-specific constants and install modes for Ninarium.
...
const wchar_t kProductPathName[] = L"Ninarium";

const size_t kProductPathNameLength = _countof(kProductPathName) - 1;

const char kSafeBrowsingName[] = "ninarium";

const InstallConstants kInstallModes[] = {
    // The primary (and only) install mode for Ninarium.
    {
        .size = sizeof(kInstallModes[0]),
        .index = CHROMIUM_INDEX,  // The one and only mode for Ninarium.
        .install_switch =
        ...
        .base_app_name = L"Ninarium",              // A distinct base_app_name.
        .base_app_id = L"Ninarium",                // A distinct base_app_id.
        .browser_prog_id_prefix = L"NinariumHTM",  // Browser ProgID prefix.
        .browser_prog_id_description =
            L"Ninarium HTML Document",         // Browser ProgID description.
        .pdf_prog_id_prefix = L"NinariumPDF",  // PDF ProgID prefix.
        .pdf_prog_id_description =
            L"Ninarium PDF Document",  // PDF ProgID description.
        .active_setup_guid =
