...
const wchar_t kPolicyRegistryKey[] = L"SOFTWARE\\Policies\\Google\\Ninarium";
const wchar_t kUserDataDirNameSuffix[] = L"\\Google\\Ninarium\\User Data";
#elif BUILDFLAG(GOOGLE_CHROME_FOR_TESTING_BRANDING)
// kPolicyRegistryKey: same as Chromium
const wchar_t kPolicyRegistryKey[] = L"SOFTWARE\\Policies\\Ninarium";
const wchar_t kUserDataDirNameSuffix[] =
    L"\\Google\\Chrome for Testing\\User Data";
#else
const wchar_t kPolicyRegistryKey[] = L"SOFTWARE\\Policies\\Ninarium";
const wchar_t kUserDataDirNameSuffix[] = L"\\Ninarium\\User Data";
#endif
